...
Blockly.Msg.ARD_ANALOGREAD = "preberi analogni pin#";  
Blockly.Msg.ARD_ANALOGREAD_TIP = "Vrni vrednosti med 0 in 1024";  
Blockly.Msg.ARD_ANALOGWRITE = "nastavi analogni pinn#";  
Blockly.Msg.ARD_ANALOGWRITE_TIP = "Napiši analogno vrednost med 0 in 255 na določena PWM vrata";  
Blockly.Msg.ARD_BUILTIN_LED = "nastavi vgrajeno LED";  
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Prižgana ali ugasnjena vgrajena LED na Arduino";  
Blockly.Msg.ARD_COMPONENT_WARN1 = "Konfiguacijska kocka %1 z istim %2 imenom mora biti dodan, da lahko uporabite to kocko!"; 
Blockly.Msg.ARD_DEFINE = "Definiraj";  
Blockly.Msg.ARD_DIGITALREAD = "preberi digitalni pin#";  
Blockly.Msg.ARD_DIGITALREAD_TIP = "Preberi digitalni pin: HIGH ali LOW";  
Blockly.Msg.ARD_DIGITALWRITE = "nastavi digitalni pin#";  
Blockly.Msg.ARD_DIGITALWRITE_TIP = "Napiši digitalno vrednost HIGH ali LOW na določena vrata";  
Blockly.Msg.ARD_FUN_RUN_LOOP = "Neskončna zanka:";  
Blockly.Msg.ARD_FUN_RUN_SETUP = "Začetne nastavitve:";  
Blockly.Msg.ARD_FUN_RUN_TIP = "Definiraj Arduino setup() in loop() funkcije.";  
Blockly.Msg.ARD_HIGH = "HIGH";  // untranslated
Blockly.Msg.ARD_HIGHLOW_TIP = "Nastavi pin na logično stanje High ali Low.";  
Blockly.Msg.ARD_LOW = "LOW";  // untranslated
Blockly.Msg.ARD_MAP = "Map(preslikava)";  
Blockly.Msg.ARD_MAP_TIP = "Preslika število iz [0-1024] na drugo.";  
Blockly.Msg.ARD_MAP_VAL = "vrednost na [0-";  
Blockly.Msg.ARD_NOTONE = "Ugasni zvok na pin #";  
Blockly.Msg.ARD_NOTONE_PIN = "Ni zvoka na PIN#";  
Blockly.Msg.ARD_NOTONE_PIN_TIP = "Nehaj generirati zvok na pin";  
Blockly.Msg.ARD_NOTONE_TIP = "Izklop zvoka na določenem pinu"; 
Blockly.Msg.ARD_PIN_WARN1 = "Pin %1 je potreben za %2 kot pin %3. Že uporabljen kot %4.";  
Blockly.Msg.ARD_PULSEON = "pulz na pin#";  
Blockly.Msg.ARD_PULSEREAD = "Preberi";  
Blockly.Msg.ARD_PULSETIMEOUT = "po";  
Blockly.Msg.ARD_PULSETIMEOUT_MS = "";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "Izmeri čas trajanja pulza na izbranem pinu, če je znotraj timeouta.";  
Blockly.Msg.ARD_PULSE_TIP = "Izmeri čas trajanja pulza na izbranem pinu.";  
Blockly.Msg.ARD_SERIAL_BPS = "bps";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT = "prikaži";  
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "dodaj novo vrstico";  
...
Blockly.Msg.ARD_SERIAL_SETUP = "Nastavitev";  
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "Selects the speed for a specific Serial peripheral";  // untranslated
Blockly.Msg.ARD_SERIAL_SPEED = ":  hitrost na";  
Blockly.Msg.ARD_SERVO_READ = "preberi SERVO iz PIN#";  
Blockly.Msg.ARD_SERVO_READ_TIP = "Preberi SERVO kot"; 
Blockly.Msg.ARD_SERVO_WRITE = "nastavi SERVO iz Pin";  
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "Stopinj (0~180)";  
Blockly.Msg.ARD_SERVO_WRITE_TIP = "Nastavi Servo na izbran kot"; 
Blockly.Msg.ARD_SERVO_WRITE_TO = "na";  
Blockly.Msg.ARD_SETTONE = "Nastavi ton na pin #";  
Blockly.Msg.ARD_SPI_SETUP = "Nastavitev"; 
Blockly.Msg.ARD_SPI_SETUP_CONF = "konfiguracija:";  
...
Blockly.Msg.ARD_SPI_SETUP_MODE0 = "0 (Low - Padajoče)";  
Blockly.Msg.ARD_SPI_SETUP_MODE1 = "1 (Low - Naraščajoče)";  
Blockly.Msg.ARD_SPI_SETUP_MODE2 = "2 (High - Padajoče)";  
Blockly.Msg.ARD_SPI_SETUP_MODE3 = "3 (High - Naraščajoče)";  
...
Blockly.Msg.ARD_SPI_TRANS_NONE = "noben";  
...
Blockly.Msg.ARD_SPI_TRANS_VAL = "prenesti";  
Blockly.Msg.ARD_SPI_TRANS_WARN1 = "A setup block for %1 must be added to the workspace to use this block!";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_WARN2 = "Stara vrednost na pinu %1 ni več na voljo.";  
Blockly.Msg.ARD_STEPPER_COMPONENT = "koračnik";  
Blockly.Msg.ARD_STEPPER_DEFAULT_NAME = "Moj koračnik";  
Blockly.Msg.ARD_STEPPER_MOTOR = "koračni motor:";  
Blockly.Msg.ARD_STEPPER_PIN1 = "pin1#";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN2 = "pin2#";  // untranslated
Blockly.Msg.ARD_STEPPER_REVOLVS = "koliko korakov na en obrat";  
Blockly.Msg.ARD_STEPPER_SETUP = "Nastavi koračni motor";  
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "Configures a stepper motor pinout and other settings.";  // untranslated
Blockly.Msg.ARD_STEPPER_SPEED = "nastavi hitrost (rpm) na";  
Blockly.Msg.ARD_STEPPER_STEP = "premakni koračnik";  
Blockly.Msg.ARD_STEPPER_STEPS = "korakov";  
Blockly.Msg.ARD_STEPPER_STEP_TIP = "Turns the stepper motor a specific number of steps.";  // untranslated
Blockly.Msg.ARD_TIME_DELAY = "počakaj";  
Blockly.Msg.ARD_TIME_DELAY_MICROS = "mikrosekund"; 
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "Počakaj za določen čas v mikrosekundah";  
Blockly.Msg.ARD_TIME_DELAY_TIP = "Počakaj za določen čas v milisekundah";  
Blockly.Msg.ARD_TIME_INF = "čakaj v neskončnost (konec programa)";  
...
Blockly.Msg.ARD_TIME_MS = "milisekund";  
Blockly.Msg.ARD_TONEFREQ = "pri frekvenci";  
Blockly.Msg.ARD_TONE_FREQ = "frekvenca";  
Blockly.Msg.ARD_TONE_PIN = "Tonski PIN#";  
Blockly.Msg.ARD_TONE_PIN_TIP = "Generiraj zvok na pin";  
...
Blockly.Msg.ARD_TYPE_CHAR = "Znak (character)";  
...
Blockly.Msg.ARD_TYPE_NUMBER = "Številka";  // untranslated
Blockly.Msg.ARD_TYPE_SHORT = "Kratka številka";  
Blockly.Msg.ARD_TYPE_TEXT = "Text";  // untranslated
Blockly.Msg.ARD_TYPE_UNDEF = "Undefined";  // untranslated
Blockly.Msg.ARD_VAR_AS = "kot";  
Blockly.Msg.ARD_VAR_AS_TIP = "Nastavi vrednost na določen tip";  // untranslated
Blockly.Msg.ARD_WRITE_TO = "na";  
...
Blockly.Msg.LISTS_SORT_TYPE_NUMERIC = "numerično"; 
Blockly.Msg.LISTS_SORT_TYPE_TEXT = "abecedni";  // 
...
Blockly.Msg.TURN_FOR = "Zavij:";
Blockly.Msg.GO_FORWARD_FOR = "Pelji naravnost:";
Blockly.Msg.BUTTON_PRESS = "Pritisnjen gumb";
Blockly.Msg.BEEPING = "Pisk -";
Blockly.Msg.FREQUENCYY = "Frekvenca:";
Blockly.Msg.DURATION = "  Čas:";
Blockly.Msg.CALIB = "Kalibracija";
Blockly.Msg.BEEP = "Robotek zapiska z določeno frekvenco za izbran čas."; 
Blockly.Msg.BUTTON_PRESSED = "Če je gumb na robotku pritisnjen, sistem vrne vrednost 1. "; 
Blockly.Msg.GO_FORWARD = "Robotek naj pelje naravnost za določeno razdaljo v centimetrih."; 
Blockly.Msg.TURN = "Robotek naj se zavrti za določen kot."; 
Blockly.Msg.CALIBRATE = "Robotek bo skalibriral svoje senzorje za zaznavanje črte, tako da bodo dajali vsi vrednosti med 0 in 1023(od najmanjše do največje vrednosti za posamezne senzorje)."; 
Blockly.Msg.NOTE = "Ton:";
Blockly.Msg.NOTES = "Robotek zapiska z določenim tonom za izbran čas."; 
